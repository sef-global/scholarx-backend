...
describe('typeorm connection', () => {
    it('should test typeorm connection', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect((0, exports.initConnection)()).resolves.not.toThrow();
    }));
});
