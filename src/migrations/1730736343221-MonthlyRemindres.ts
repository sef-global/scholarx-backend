...
export class MonthlyRemindres1730736343221 implements MigrationInterface {
  name = 'MonthlyRemindres1730736343221'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_19e37bcbcb83cf968be2ffe4e6"`
    )
    await queryRunner.query(`DROP TABLE "email"`)
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a3a54d6277c44b67774295c88b"`
    )
